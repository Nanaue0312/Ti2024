    ...
    switch (DL_I2C_getPendingInterrupt(I2C_MPU6050_INST)) {
        ...
        case DL_I2C_IIDX_CONTROLLER_RXFIFO_TRIGGER:
            ...
            while (DL_I2C_isControllerRXFIFOEmpty(I2C_MPU6050_INST) != true) {
                if (gRxCount < gRxLen) {
                    gRxPacket[gRxCount++] = DL_I2C_receiveControllerData(I2C_MPU6050_INST);
                } else {
        ...
        case DL_I2C_IIDX_CONTROLLER_TXFIFO_TRIGGER:
            ...
            if (gTxCount < gTxLen) {
                gTxCount += DL_I2C_fillControllerTXFIFO(I2C_MPU6050_INST, &gTxPacket[gTxCount], gTxLen - gTxCount);
            }
            break;
